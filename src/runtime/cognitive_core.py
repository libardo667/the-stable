...
class CognitiveCore:
    ...
    def __init__(
        ...
        *,
        ...
        # Honest situational grounding (Major 70): the world reports VERIFIABLE facts about this
        # entity's circumstances; render_situational_briefing turns them into a briefing that states
        # what is true and withholds every verdict about what it means. The briefing folds into the
        # system prompt's GROUND TRUTH block. A world that reports none (a bare stub) yields no
        # situational claims at all — silence beats the false city story this replaced. ``solo`` (a
        # one-resident world) also drops the citywide affordances from the per-tick pulse contract.
        facts: dict[str, Any] = {}
        ...
        self._producer.solo = bool(facts.get("solo"))
