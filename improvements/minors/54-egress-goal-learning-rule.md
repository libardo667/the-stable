...
- ID: 54-egress-goal-learning-rule
...
`web` (the first egress tool; shipped this round under the Major 54 capability surface) is
...
- Links: 57-the-keeper-to-familiar-seam-a-second-safety-invariant (the hazard-cell framing),
  Major 54 (the capability surface that introduced egress).
