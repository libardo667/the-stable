...
experiments: dischargeable-longing arms (Major 63), mechanism-lesioned living twins (Major 64),
transplant distress (Major 65), and the keeper's named future vein (2026-06-11): cultural
...
- [ ] Scope definition cleanly classifies the four pending majors (63 in, 66 out, 64 split by lesion class, 65 in)
- [ ] Stop conditions are required to be mechanically checkable, not vibes
- [ ] The quality-gate line exists and Majors 63/64/65 cite compliance sections before any living arm runs
...
state — but removal after Majors 63–65 exist should itself be treated as a red flag and
